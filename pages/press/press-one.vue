    ...
    <section>
      <div class="max-w-6xl px-4 py-12 mx-auto space-y-6">
        <img
          ...
          alt="Govt Cuts Private Housing Supply From Confirmed Land Sale Sites : Straight Times"
          class="mx-auto"
        />
        <h1 class="max-w-5xl mx-auto text-justify">
                 ...
                 yield 905 residential units and 540 hotel rooms.
                  ...
                  <br>
                  <h3 class="text-center"> Source: https://www.straitstimes.com/business/property/govt-cuts-private-housing-supply-from-confirmed-land-sale-sites-due-to-covid-19</h3>
